...
public  class CommodityCC implements ContractInterface {
    ...
    @Transaction()
    public Commodity query(Context ctx, String key) {
    ...
    public void initLedger(Context ctx) {
        ChaincodeStub stub = ctx.getStub();
        String MedData ="{\"digest\":\"init\",\"id\":\"init\"}";
    ...
    @Transaction()
    public void insert(Context ctx, String id,String digest)
    {
        ChaincodeStub stub = ctx.getStub();
    ...
    @Transaction()
    public void update(Context ctx, String id, String newDigest) {
        ChaincodeStub stub = ctx.getStub();
        String commState = stub.getStringState(id);
        if (commState.isEmpty())
        {
